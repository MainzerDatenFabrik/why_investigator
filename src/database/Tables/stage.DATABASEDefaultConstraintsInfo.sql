CREATE TABLE [stage].[DATABASEDefaultConstraintsInfo]
(
...
[Column_NBR] [int] NULL,
[Defaults] [nvarchar] (4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[DefaultName] [nvarchar] (4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
